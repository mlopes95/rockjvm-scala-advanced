...
object CurriesPAF extends App {
  ...
  val add7ETAExpansion_v2 =
    curriedAddMethod(7)(_) // Partially Applied Function -> Alternative syntax
  val add7SimpleMethod = (y: Int) => simpleAddMethod(7, y)

  val add7_v2Simple =
    simpleAddMethod(7, _: Int) // alternative syntax for turning methods into function values
  ...
  /**   1. Process a list of numbers and return their string representations with different formats
    *      Use the %4.2f, %8.6f and %14.12f with a curried formatter function "4.2f".format(Math.PI)
    */
